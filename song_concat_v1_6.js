...
$('.question').each(function(){
	$(this).css("margin","0px");
	$(this).parent().append($('<br><input id="'+$(this).find('span')[0].id+'t" style="margin-left:30px;" type="text" placeholder="โปรดพิมพ์เนื้อร้อง..." maxlength="40"></input></input><span id="'+$(this).find('span')[0].id+'r"> (ยังไม่ได้ใส่เนื้อ)</span><br><input id="'+$(this).find('span')[0].id+'b" type="button" value="เฉลย"><br><br>'));
	var btnt;
	var btnf;
	...
	$('#'+$(this).find('span')[0].id+'b').press(function() {
		$.ajax({
